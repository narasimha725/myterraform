# S3 Bucket to Store Lambda Cod
resource "aws_s3_bucket" "lambda_bucket" {
  bucket        = "lambdatos3bucket9346"
  acl           = "private"
  force_destroy = true
...
resource "aws_s3_object" "lambda_code" {
  ...
  key    = "C:/Users/DELL/Downloads/lambda_function.zip"
  source = "lambda_function.zip"
  
   # Path to your zip file containing the Lambda code
...
resource "aws_iam_role_policy_attachment" "lambda_basic_execution" {
  ...
  policy_arn = "arn:aws:iam::396913744737:policy/s3policy"
}
